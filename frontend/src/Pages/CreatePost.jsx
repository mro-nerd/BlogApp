...
const CreatePost = () => {
    ...
    const handleCreate=async (e)=>{
        ...
        if(file){
          ...
          data.append("img",filename)//giving filename
          data.append("file",file)//giving file data
          post.photo=filename//once unique img file is created it is then transfered to post.photo
           console.log(data)
          //img upload
          try{
